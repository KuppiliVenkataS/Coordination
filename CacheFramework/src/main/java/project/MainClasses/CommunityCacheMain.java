 ...
 */
public class CommunityCacheMain implements PropertiesLoaderImplBase,NetworkConstants{
    ...
    public CommunityCacheMain(int noOfQueries) {
...
//                                nextQuery.getState9().getStartTimeState9() + " end time " + nextQuery.getState9().getEndTimeState9());
    ...
    public double runQueriesThroughStates(int NUMBER_OF_QUERIES, String criteria, String maintenanceCriteria) throws InterruptedException, IOException {
        ...
        switch(maintenanceCriteria){
            case TIME_THRESHOLD_ONLY: {
                 fileOut = "//home//santhilata//Dropbox//CachelearningResults//Cache_stability_TIME_"+TIME_THRESHOLD+"_"+NUMBER_OF_QUERIES+"_"+criteria+".csv";
            ...
            case FREQUENCY_THRESHOLD_ONLY :{
                fileOut = "//home//santhilata//Dropbox//CachelearningResults//Cache_stability_FREQUENCY_"+FREQUENCY_THRESHOLD+"_"+NUMBER_OF_QUERIES+"_"+criteria+".csv";
            ...
            case COMBINED_ALGO_MAINTENANCE: {
                fileOut = "//home//santhilata//Dropbox//CachelearningResults//Cache_stability_COMBINED_"+TIME_THRESHOLD+"_"+FREQUENCY_THRESHOLD+"_"+NUMBER_OF_QUERIES+"_"+criteria+".csv";
    ...
    public void runContinuously() throws IOException, InterruptedException {
       ...
       // File outputImprovedCacheLearning = new File(".//src//main//java//project//QueryEnvironment//QueryOutput//Cache_output_5subquery_overlap.csv");
        File outputImprovedCacheLearning = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_dataFound_details.csv");
...
//
    ...
    public void run_non_overlapQueries() throws IOException, InterruptedException {
        File outputFile = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_non_overlap.csv");
    ...
    public void run_40PC_60PC_OverlapQueries() throws IOException, InterruptedException {
       ...
       // File outputFile = new File(".//src//main//java//project//QueryEnvironment//QueryOutput//Cache_output_40_60_overlap.csv");
        File outputFile = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_dataFound_details.csv");
        FileWriter writer = new FileWriter(outputFile);
        writer.flush();
    ...
    public void runSampleQueryTraces() throws IOException, InterruptedException {
        ...
        File outputFile = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_time_threshold.csv");
        FileWriter writer = new FileWriter(outputFile);
        writer.flush();
    ...
    public void checkCacheStability_TimeThreshold() throws IOException, InterruptedException {
        ...
        for (int i = 1; i < 10;  i++) { // this loop is for number of queries
            int Max_No_queries = (i * 1000) ; // change this val to 10000
            this.setNoOfQueries(Max_No_queries);
                ...
                for (int overlapPercentage = 40; overlapPercentage < 42; overlapPercentage += 20)  {
                    ...
                    for(Querycriteria qc:Querycriteria.values()) {// full query search and partial query search
                        ...
                        for (int j = 4; j < 6; j++) {
                            ...
                            for (int time_threshold = 1; time_threshold < 2; time_threshold++) { //

                                for (int fixedTimeGap = 3; fixedTimeGap < 4; fixedTimeGap++) { //
    ...
    public void checkCacheStability_FrequencyThreshold() throws IOException, InterruptedException {
         ...
         File outputFile = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_frequency_threshold.csv");
        FileWriter writer = new FileWriter(outputFile);
        writer.flush();
                ...
                for (int overlapPercentage = 40; overlapPercentage < 42; overlapPercentage += 20)  {
                    ...
                    for(Querycriteria qc:Querycriteria.values()) {// full query search and partial query search
                       ...
                       for (int j = 4; j < 5; j++) {
                           ...
                           for (int frequency_threshold = 0; frequency_threshold < 1; frequency_threshold++) { //upto 2500

                               for (int fixedTimeGap = 3; fixedTimeGap < 4; fixedTimeGap++) { // time gap for the query arrival is set to 2;
     ...
     * variations time threshold, data size threshold and frequency threshold
     */
    public void checkCacheStability_DynamicThreshold() throws IOException, InterruptedException {

        File outputFile = new File("//home//santhilata//Dropbox//CachelearningResults//Cache_output_dynamic_threshold.csv");
        FileWriter writer = new FileWriter(outputFile);
        writer.flush();

        writer.append("NoOfQueries,query search type, Overlap Percentage, no_of_subqueries,ResponseTime,Average Data Found, Average Data Not Found, Time Threshold, Frequency threshold, number_queries Added, number_queries deleted, CacheHits, Cache Accesses, av_lifeSpan");
        writer.append('\n');
