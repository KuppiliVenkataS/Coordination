package project.QueryEnvironment.QueryInput.SlowChange;

import org.apache.commons.math3.distribution.ExponentialDistribution;
import org.apache.commons.math3.distribution.PoissonDistribution;
import org.apache.commons.math3.distribution.UniformIntegerDistribution;
import project.QueryEnvironment.QueryInput.QueryGenerator;
 ...
 * Slow configuration change generates 10 queries of each complexity and changes them slowly
 */
public class QueryGenerator_slowChangeConfig {

    private static  final String[] conditionArray = {"eq","gt","lt","gte","lte","true","false","other",
            "between"};

    private static final int databases = 2;
    private static final int tables = 5;
    private static final int attributes = 10;
...
//            ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryGenerator_output";
    public static final String BACKUP_FILE = "" +
            ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//Backup";


    public QueryGenerator_slowChangeConfig(){
    ...
    private void createSQSS(){
        ...
        for(int database=1; database < databases; database++) { // for all 6 databases
            for(int table = 1; table < tables; table++){ // for 5 tables
                for (int attribute =1; attribute<16; attribute++){ // for all 15 attributes in each table
                ...
                for (int attribute =1; attribute<attributes; attribute++) { // for all 15 attributes in each table
                    ...
                    for(int i=0; i < noOfAttr.nextInt(4); i++){

                        tempSQS = tempSQS+"at"+randomIndex.nextInt(16)+";";
                    }
                    tempSQS = tempSQS+"at"+randomIndex.nextInt(16)+table+database+":t"+table+database+":d"+database;
                    sqss.add(tempSQS);
                    tempSQS="";
                }
            }
    ...
    private void createPQSS( ){
        ...
        for (int p = 0; p < noOfPQSS ; p++) {
            ...
            UniformIntegerDistribution uniform = new UniformIntegerDistribution(1, noOfSQS-1);
...
//                System.out.println("cardinality is "+cardinality);
    ...
    private ArrayList<String> createQuerySegments(int numberOfQuerySegments){
        ...
        for (int i = 0; i < numberOfQuerySegments ; i++) {
            ...
            int noOfSQSInQuery = 0;

            while (noOfSQSInQuery == 0) {
                noOfSQSInQuery = new Random().nextInt(4);    // number of columns
            }
    ...
    private void getQueryExpressions_oneNode_40PCOverlap(){
        ...
        try{
            BufferedWriter out1 = new BufferedWriter(new FileWriter( ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions1_40PCOverlap_10000"));
            int sample_value1=0;
...
//        int number_of_queries =1000;
        ...
        try{
            BufferedWriter out1 = new BufferedWriter(new FileWriter( ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions1_60PCOverlap_10000"));
            int sample_value1=0;
            fixed_segment1 = getSampleFromDistribution(distribution);
            while (fixed_segment1 >= NUMBER_OF_QUERY_SEGMENTS )     {
                fixed_segment1 =    getSampleFromDistribution(distribution);
    ...
    /**
     * Following function generates query input with 60% overlap
     */
    private void getQueryExpressions_60PC_oneNode_60PCOverlap(){
        int fixed_segment1 = 0;
        int number_of_queries =10000;
//        int number_of_queries =1000;
        ArrayList<String> queryList = new ArrayList<>();
    ...
    private void getQueryExpressions_twoNode_40PCOverlap(){
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter( ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions2_40PCOverlap_10000"));
    ...
    private void getQueryExpressions_twoNode_60PCOverlap(){
        ...
        ArrayList<String> queryList = new ArrayList<>();
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter( ".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions2_60PCOverlap_10000"));
            int sample_value1=0;
            int sample_value2=0;
            String q = "";
    ...
    private void getQueryExpressions_threeNode_40PCOverlap(){
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions3_40PCOverlap_10000"));
 ...
 */
    ...
    private void getQueryExpressions_threeNode_60PCOverlap(){
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions3_60PCOverlap_10000"));
...
//            int querySegment[][] = new int[1000][3];
    ...
    private void getQueryExpressions_fourNode_40PCOverlap(){
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions4_40PCOverlap_10000"));
 ...
 */
    ...
    private void getQueryExpressions_fourNode_60PCOverlap(){
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions4_60PCOverlap_10000"));
            int querySegment[][] = new int[10000][4];
 ...
 */
    ...
    private void getQueryExpressions_fiveNode_40PCOverlap() {
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions5_40PCOverlap_10000"));
...
//            System.out.println("limit fixed queries ="+limit);
    ...
    private void getQueryExpressions_fiveNode_60PCOverlap() {
        ...
        try {
            BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//QueryExpressions5_60PCOverlap_10000"));
            int querySegment[][] = new int[10000][5];
...
//            System.out.println("limit fixed queries ="+limit);
    ...
    /**
     * Mixed bag of queries
     * 20 tags (query segments are generated with multiple number of nodes)
     * Each tag is repeated 30% of the time
     * TODO
     */

    public void getMixedBagQueryExpressions_30PCOverlap(){
        int number_of_queries = 10000;

        for (int i = 0; i < 20; i++) {

            int no_of_nodes = new Random().nextInt(5)+1; // +1 is to avoid zero value. no_of_nodes decides the query complexity
...
/**
 * 20 queries are created and repeated within the query trace
 */

private void getQueryExpressions_threeNode_40PCOverlap_20FullQueries(){
    ...
    try {
        BufferedWriter out1 = new BufferedWriter(new FileWriter(".//src//main//java//project//QueryEnvironment//QueryInput//SlowChange//20FullQueries_QueryExpressions3_40PCOverlap_10000"));
